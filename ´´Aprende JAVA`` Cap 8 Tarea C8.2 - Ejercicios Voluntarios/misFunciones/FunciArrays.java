...
public class FunciArrays{
	...
	/**
	 * Devuelve el array de números enteros generado.
	 * 
	 * @param tam un número entero igual o mayor que 1.
	 * @return num un array unidimensional de números enteros.
	 */
	
	public static int[] introduceArrayInt(int tam){
	 ...
	 * @return arraySoloCon7[] un array de números enteros que contiene todos los números que contienen el 7.
	 */
	
	public static int[] filtraCon7(int[] x){
		
		int[] arrayCopia = new int[x.length], arrayIntermedio = new int[x.length];
		boolean contiene7;
		int k = 0, cont = 0;
		...
		for(int i=0; i<x.length; i++){
			...
			for(int j=1; j<=(int)(Math.log10(x[i]))+1; j++){
				if(arrayCopia[i]%10==7){
					contiene7 = true;
				}
		...
		if(cont>0){
			arrayCon7 = new int[cont];
		
			for(int i=0; i<arrayCon7.length; i++){
				arrayCon7[i] = arrayIntermedio[i];
			}
		} else{
			arrayCon7 = new int[1];
			arrayCon7[0] = -1;
	...
	/**
	 * Devuelve una cadena de caracteres concatenando los números del array que se introduce.
	 * 
	 * @param array un array de números enteros.
	 * @return arrayEnString un String de los números del array concatenados en un solo String.
	 */
	...
	public static String convierteArrayEnString(int[] array){
		...
		for(int i=0; i<array.length; i++){					// Concatenamos cada número del array al String que hemos construido hasta el momento.
			arrayEnString+=Math.abs(array[i]);
		}
